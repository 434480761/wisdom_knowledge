		...
		try {
			...
			if (StringUtils.isNotEmpty(url)) {
				...
				if (pathChunks != null
					...
					if (ResourceTypeSupport.isValidEsResourceType(resourceType)) {
						esResourceOperation.asynAdd(new Resource(resourceType,
								uuid));
					}
