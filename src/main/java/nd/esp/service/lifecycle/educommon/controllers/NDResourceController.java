...
public class NDResourceController {
    ...
    ResourceViewModel getDetail(@PathVariable("res_type") String resourceType,
                                ...
                                @RequestParam(value = "recycled", required = false, defaultValue = "false") Boolean isRecycled) {
        ...
        //调用servicere
        ResourceModel modelResult = ndResourceService.getDetail(resourceType, uuid, includeList, isAll, isRecycled);
        // 如果是教学目标，它的title实时计算
    ...
    Map<String, ResourceViewModel> batchDetail(@PathVariable("res_type") String resourceType,
        ...
        List<ResourceModel> modelListResult = ndResourceService.batchDetail(resourceType, uuidSet, includeList, false, isRecycled);
    ...
    public
    @ResponseBody
    Map<String, String> delete(@PathVariable("res_type") String resourceType, @PathVariable("uuid") String uuid, @RequestParam(required = false, defaultValue = "false", value = "refresh_suite") boolean refreshSuite) {

        requestDelete(resourceType, uuid);
    ...
    public
    @ResponseBody
    Map<String, String> batchDelete(@PathVariable("res_type") String resourceType,
                                    @RequestParam(value = "rid", required = true) Set<String> uuidSet,
        ...
        Map<String,List<NotifyInstructionalobjectivesRelationModel>> relateRelationsMap = new HashMap<>();
        ...
        for (String uuid : uuidSet) {
            ...
            relateRelationsMap.put(uuid,relateRelations);
            nowStatusMap.put(uuid,nowStatus);
        }

        List<String> uuidList = new ArrayList<>();
        for (String id:uuidSet) {
            uuidList.add(id);
        }

        // 调用service,只执行一次batchDelete
        if (!CommonServiceHelper.isQuestionDb(resourceType)) {
            ndResourceService.batchDelete(resourceType, uuidList);
        } else {
            ndResourceService.batchDeleteInQuestionDB(resourceType, uuidList);
        }
        ...
        for(String uuid:uuidSet) {
            ...
            String nowStatus = nowStatusMap.get(uuid);
            List<NotifyInstructionalobjectivesRelationModel> relateRelations = relateRelationsMap.get(uuid);
    ...
    public
    @ResponseBody
    Map<String, String> deleteInstructionalObjective(
    ...
    public ListViewModel<ResourceViewModel> requestQueringBySolr(
            ...
            @RequestParam(required = false, value = "enable", defaultValue = "true") boolean isEnable,
            @RequestParam String words, @RequestParam String limit) {

        return requestQuering(resType, null, resCodes, includes, categories, categoryExclude, relations, null, coverages, props, orderBy, words, limit, QueryType.DB, true, reverse, printable, printableKey, statisticsType, statisticsPlatform, forceStatus, tags, showVersion, false, isEnable);
    ...
    public ListViewModel<ResourceViewModel> requestQueringByEs(
        ...
        return requestQuering(resType, null, resCodes, includes, categories,
                ...
                QueryType.ES, !isAll, "false", printable, printableKey, null, null, false, null, false, false, true);
    }
    ...
    public ListViewModel<ResourceViewModel> requestQueringByTitan(
        ...
        return requestQuering(resType, null, resCodes, includes, categories,
                ...
                reverse, printable, printableKey, statisticsType, statisticsPlatform, forceStatus, tags, showVersion, false, true);
    }
    ...
    public ListViewModel<ResourceViewModel> requestQueringByTitanES(
        ...
        return requestQuering(resType, fields, resCodes, includes, categories,
                ...
                reverse, printable, printableKey, null, null, false, null, false, false, true);
    }
    ...
    public ListViewModel<ResourceViewModel> requestQueringByDBAndManagement(
        ...
        if (CollectionUtils.isNotEmpty(props)) {
            ...
            resourceViewModelListViewModel = requestQuering(resType, null, resCodes, includes, categories, categoryExclude, relations, relationsExclude, coverages, newProps, orderBy, words, limit, QueryType.DB, false, reverse, printable, printableKey, statisticsType, statisticsPlatform, false, tags, showVersion, firstKnLevel, isEnable);
        } else {
            resourceViewModelListViewModel = requestQuering(resType, null, resCodes, includes, categories, categoryExclude, relations, relationsExclude, coverages, props, orderBy, words, limit, QueryType.DB, false, reverse, printable, printableKey, statisticsType, statisticsPlatform, false, tags, showVersion, firstKnLevel, isEnable);
        }
    ...
    public ListViewModel<ResourceViewModel> requestQueringByDB(
        ...
        return requestQuering(resType, null, resCodes, includes, categories, categoryExclude, relations, null, coverages, props, orderBy, words, limit, QueryType.DB, true, reverse, printable, printableKey, statisticsType, statisticsPlatform, forceStatus, tags, showVersion, firstKnLevel, isEnable);
    }
    ...
    private ListViewModel<ResourceViewModel> requestQuering(String resType, String retrieveFields, String resCodes, String includes,
                                                            ...
                                                            boolean showVersion, boolean firstKnLevel, boolean isEnable) {
        ...
        Map<String, Object> paramMap =
                requestParamVerifyAndHandle(resType, retrieveFields, resCodes, includes, categories, categoryExclude,
                        relations, relationsExclude, coverages, props, orderBy, words, limit, queryType, reverse, isEnable);
        ...
        switch (queryType) {
            case DB:
                if (StaticDatas.QUERY_BY_ES_FIRST && isEnable
                    ...
                    try {
                        ...
                        rListViewModel = resourceQueryByDB(resType, resCodes, categories, categoryExclude, words,
                                ...
                                orderMap, reverseBoolean, firstKnLevel, isEnable);
                    }
                } else if (StaticDatas.QUERY_BY_TITAN_FIRST && isEnable
                    ...
                    try {
                       ...
                       /* rListViewModel = ndResourceService.resourceQueryByTitan(resType,
                        ...
                        rListViewModel = resourceQueryByDB(resType, resCodes, categories, categoryExclude, words,
                                ...
                                coveragesList, propsMap, orderMap, reverseBoolean, firstKnLevel, isEnable);
                    }
                } else {
                    rListViewModel = ndResourceService.resourceQueryByDB(resType,
                            ...
                            statisticsPlatform, forceStatus, tags, showVersion, isEnable);
                }
                break;
            case ES:
    ...
    private ListViewModel<ResourceModel> resourceQueryByDB(String resType, String resCodes, Set<String> categories,
                                                           ...
                                                           boolean reverseBoolean, boolean firstKnLevel, boolean isEnable) {
        ...
        rListViewModel = ndResourceService.resourceQueryByDB(
                ...
                reverseBoolean, printable, printableKey, firstKnLevel, statisticsType, statisticsPlatform, forceStatus, tags, showVersion, isEnable);
...
//        Map<String, String> orderBys = TitanUtils.dealOrderMap(orderMap, showVersion, reverse, relations, statisticsType, statisticsPlatform);
        ...
        Future<ListViewModel<ResourceModel>> dbFuture = excetorService.submit(new Callable<ListViewModel<ResourceModel>>() {
            ...
            public ListViewModel<ResourceModel> call() throws Exception {
                return ndResourceService.resourceQueryByDB(resType,
                        ...
                        limit, isNotManagement, reverse, printable, printableKey, false, statisticsType, statisticsPlatform, forceStatus, tags, showVersion, true);
            }
        });
        return dbFuture;
    }
    ...
    private boolean canQueryByEla(String resType, List<Map<String, String>> relations, List<Map<String, String>> relationExclude,
        ...
        if ((isNotManagement
                ...
                .containsKey("taxOnCode"))))) || (!isNotManagement && StaticDatas.KNOWLEDGE_DB_QUERY_BY_ES_FIRST && resType.equals(IndexSourceType.KnowledgeType.getName()))) {
    ...
    private Map<String, Integer> requestCounting(String resType, Set<String> categories, Set<String> coverages,
        ...
        Map<String, Object> paramMap =
                requestParamVerifyAndHandle(resType, null, null, null, categories, null, null, null,
                        coverages, props, null, null, "(0,1)", QueryType.DB, null, true);
    ...
    private Map<String, Object> requestParamVerifyAndHandle(String resType, String fields, String resCodes, String includes,
                                                            Set<String> categories, Set<String> categoryExclude, Set<String> relations, Set<String> relationsExclude, Set<String> coverages, List<String> props,
                                                            List<String> orderBy, String words, String limit, QueryType queryType, String reverse, boolean isEnable) {
        //reverse,默认为false
        ...
        if (CollectionUtils.isEmpty(relations)) {
            ...
            for (String relation : relations) {
                Map<String, String> map = ParameterVerificationHelper.relationVerification(relation, queryType, isEnable);
...
//    		offlineService.writeToCsAsync(resourceType, newResource.getIdentifier());
    ...
    /**
     * 删除的通用方法
     * <p>Create Time: 2016年11月8日   </p>
     * <p>Create author: gzp   </p>
     *
     * @return
     */
    private void requestDelete(String resourceType, String uuid) {
        // UUID校验
        if (!CommonHelper.checkUuidPattern(uuid)) {
            throw new LifeCircleException(HttpStatus.INTERNAL_SERVER_ERROR,
                    LifeCircleErrorMessageMapper.CheckIdentifierFail.getCode(),
