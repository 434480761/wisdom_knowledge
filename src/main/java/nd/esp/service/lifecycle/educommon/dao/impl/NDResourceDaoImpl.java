...
public class NDResourceDaoImpl implements NDResourceDao{
    ...
    public List<ResourceModel> commomQueryByDB(final String resType, String resCodes, final List<String> includes,
            ...
            String statisticsType,String statisticsPlatform,boolean forceStatus,List<String> tags,boolean showVersion,boolean isEnable) {
        //需要用到的变量
        ...
        Map<String, Object> map = this.getQuerySqlsAndParams(false, resType, resCodes, categories, categoryExclude, relations,relationsExclude, coverages, propsMap, words, isNotManagement, reverse, useIn,
        		printable, printableKey, orderMap,statisticsType, statisticsPlatform,forceStatus,tags,showVersion,querySqls, params,firstKnLevel,isEnable);
    ...
    public long commomQueryCount(String resType, String resCodes, Set<String> categories, Set<String> categoryExclude,
        ...
        Map<String, Object> map = this.getQuerySqlsAndParams(true, resType, resCodes, categories, categoryExclude, relations,relationsExclude, coverages, propsMap, words, isNotManagement, reverse, useIn,
        		printable, printableKey,null,null,null,forceStatus,tags,showVersion, querySqls, params,firstKnLevel,isEnable);
        @SuppressWarnings("unchecked")
		List<String> resTypes = (List<String>)map.get("resTypes");
        boolean onlyOneType = (boolean)map.get("onlyOneType");
	...
	public Map<String, Integer> resourceStatistics(String resType, Set<String> categories, List<String> coverages,
        ...
        //获取querySqls和params,并把resTypes和onlyOneType返回
        Map<String, Object> map = this.getQuerySqlsAndParams(false, resType, null, categories, null, null,null, coverages, propsMap, null, isNotManagement, false, true, null, null,null, null,null,false,null,false, querySqls, params,firstKnLevel,true);
        @SuppressWarnings("unchecked")
		List<String> resTypes = (List<String>)map.get("resTypes");
    ...
    public boolean judgeUseInOrExists(String resType, String resCodes, Set<String> categories, Set<String> categoryExclude,
        ...
        //查询上次total值--start
        Map<String, Object> map4count = getCommomQueryCountSql(resType,resCodes, categories, categoryExclude, relations,null, coverages, propsMap, words, isNotManagement, reverse, printable, printableKey,firstKnLevel,forceStatus,tags,showVersion,isEnable);
    ...
    private Map<String,Object> getQuerySqlsAndParams(boolean isCount, String resType,String resCodes, 
            ...
            List<String> querySqls,Map<String,Object> params,boolean firstKnLevel,boolean isEnable){
        //判断是否需要交集
        ...
        for(String type : resTypes){
            ...
            querySql = completeQuerySql(isCount, type, resTypes, noAndcategories, andCategories, categoryExclude, relations,relationsExclude, coverages, propsMap,
                    words, isNotManagement, reverse, paramHead, useIn, onlyOneType, printable, printableKey,firstKnLevel,forceStatus,tags,showVersion,isEnable);
    ...
    private String completeQuerySql(boolean isCount, final String resType, List<String> resTypes, Set<String> categories,
        ...
        String querySqlCondition = commonQuerySql(isCount, resType, resTypes, categories, andCategories, categoryExclude, 
        		relations,relationsExclude,coverages, propsMap, words, isNotManagement, reverse, paramHead,useIn,onlyOneType,printable,printableKey,firstKnLevel,forceStatus,tags,showVersion,isEnable);
    ...
    private String commonQuerySql(Boolean isCount, String resType, List<String> resTypes, Set<String> categories, List<List<String>> andCategories,
        ...
        //enable条件判断
        String enableCondition = isEnable ? " AND a.enable=1 " : " AND a.enable=0 ";
...
//        LOG.info("跨库查询-getTargetByRelation:" + sql);
     ...
     */
    @Override
    public List<Map<String, Object>> queryResourceByMidList(String resType, List<String> mids) {
        NamedParameterJdbcTemplate npjt = new NamedParameterJdbcTemplate(defaultJdbcTemplate);
        String sql = "select nd.identifier,nd.m_identifier,nd.title,nd.version,nd.create_time,nd.estatus,c.message from ndresource nd left join contributes c on nd.identifier = c.resource and c.title = 'version' where nd.primary_category='"
                + resType
                + "' and nd.m_identifier in (:mids) and nd.enable = 1";
        Map<String,Object> params = new HashMap<String,Object>();
        params.put("mids",mids);
        List<Map<String,Object>> returnList = npjt.queryForList(sql,params);
        return returnList;
    }
