...
public interface LifecycleServiceV06 {
     ...
     * @param uuid
     */
    public ListViewModel<ResContributeViewModel> getLifecycleSteps(String resType, String uuid, String limit,String status);
    ...
    /**
     * 批量资源增加生命周期阶段。 可以对批量资源进行同一生命周期及阶段的添加(不校验资源id是否存在)
     * @param resType
     * @param resIds
     * @param contributeModel
     * @return
     */
    public Map<String,ResContributeViewModel> addLifecycleStepBatch(String resType, List<String> resIds, ResContributeModel contributeModel);
}
