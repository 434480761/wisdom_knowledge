...
public interface EducationRelationServiceV06 {
     ...
     * @return
     */
    public List<Map<String,Object>> querySuiteDirectory(List<String> categoryList);
    
    /**
     * 根据学科维度查询套件目录树
     * @return
     */
    public List<Map<String,Object>> querySuiteDirectory(String category,String status);
     ...
     * @param num
     */
    public void recursiveSuiteDirectory(List<Map<String, Object>> list,String assetId,int num);
     ...
     * @return 最顶级套件id
     */
    public void recursiveRootSuite(String suiteId, List<String> rootSuite, Map<String,Object> parent,String relationType);
     ...
     * @param status
     */
	List<Map<String, Object>> querySuiteList(String categoryList, String status);
     ...
     * @param status
     */
	List<Map<String, Object>> querySuiteDirectory(String id);
}
