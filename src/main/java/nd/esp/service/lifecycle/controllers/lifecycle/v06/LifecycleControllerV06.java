...
public class LifecycleControllerV06 {
    ...
    public @ResponseBody ListViewModel<ResContributeViewModel> getLifecycleSteps(@PathVariable String res_type,
        ...
        ListViewModel<ResContributeViewModel> contributeViewModel = service.getLifecycleSteps(res_type, uuid, limit,null);
        return contributeViewModel;
    }
    
    /**
     * 获取指定资源的生命周期阶段详细。通过资源uuid,status获取资源阶段的详细信息
     * @Method GET
     * @urlpattern  {res_type}/{uuid}/lifecycle/steps?limit=(0,20)
     *
     * @param resType
     ...
     * @param status
     */
    @RequestMapping(value = "/{uuid}/lifecycle/steps/business", params = { "limit" }, method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody ListViewModel<ResContributeViewModel> getLifecycleStepsBusiness(@PathVariable String res_type,
            @PathVariable String uuid, @RequestParam String limit,@RequestParam String status) {
        LifecycleServiceV06 service = !CommonServiceHelper.isQuestionDb(res_type) ? lifecycleService : lifecycleService4Qti;

        ListViewModel<ResContributeViewModel> contributeViewModel = service.getLifecycleSteps(res_type, uuid, limit,status);
        return contributeViewModel;
    }
//    /**
//     * 批量获取指定资源的生命周期阶段详细。通过资源uuid获取资源阶段的详细信息
//     * @Method GET
//     * @urlpattern  {res_type}/batch/lifecycle/steps?limit=(0,20)&rid=
//     *
//     * @param res_type
//     */
//    @RequestMapping(value = "/batch/lifecycle/steps", params = { "limit" }, method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
//    public @ResponseBody Map<String,ListViewModel<ResContributeViewModel>> batchGetLifecycleSteps(@PathVariable String res_type,
//                                                                                      @RequestParam String limit,
//                                                                                      @RequestParam Set<String> rid) {
//        LifecycleServiceV06 service = !CommonServiceHelper.isQuestionDb(res_type) ? lifecycleService : lifecycleService4Qti;
...
//                resultMap.put(uuid,contributeViewModel);
//            }
//        }
//        return resultMap;
//    }
    ...
    public @ResponseBody Map<String,ListViewModel<ResContributeViewModel>> batchGetLifecycleSteps(@PathVariable String res_type,
        ...
        LifecycleServiceV06 service = !CommonServiceHelper.isQuestionDb(res_type) ? lifecycleService : lifecycleService4Qti;
        Map<String,ListViewModel<ResContributeViewModel>> resultMap = new HashMap<>();
        resultMap = service.batchGetLifecycleSteps(res_type,rid,limit);
        return resultMap;
    }
